...
void clip_window(int r, int c, t_pixel *iw, t_pixel *ow) {
   ...
   intII  first_row, last_row, first_col, last_col;
   intII  test1, test2, test3, test4;
...
***************************************************************************/
intI system_input(t_pixel din, t_pixel *cliped_window, intI *last_pixel){

   static intIX        c = 0, r = 0;
   static intIX        c_filter = 0, r_filter = 0;
   static intI  output_vld = 0;
...
***************************************************************************/
void pixel_processing(t_pixel data_in, t_pixel *data_out,t_mcu_data  *mcu_data) {
